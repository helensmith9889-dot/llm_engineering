"""模块：notebook_generator.py（社区贡献中文注释版，逻辑未改）
"""
...
# 【注】Loading .env variables
load_dotenv()

# 【注】Setting up logging
logging.basicConfig(
    level=os.getenv("LOG_LEVEL", "INFO").upper(),
    format="%(asctime)s - %(levelname)s - %(message)s"
)

# 【注】Adding project directory to sys.path
...
# 【注】Importing analyze_content from playwright_ai_scraper.py
try:
...
# 【注】Function to save the notebook
...
def save_notebook(url, content):
    ...
    # 【注】Extracting the domain from the URL
