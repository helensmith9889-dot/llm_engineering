"""模块：article_summariser-gradio.py（社区贡献中文注释版，逻辑未改）
"""
...
def clean_text(text:str) -> str:
    ...
    # 【注】Remove LaTeX-style math and formatting tags #already filtered from soup content but some still appear
    ...
    # 【注】Remove reference tags like [34] or [1,2,3]
    text = re.sub(r"\[\s*(\d+\s*(,\s*\d+\s*)*)\]", "", text)
    
    # 【注】Remove extra whitespace
