...
双向量搜索+LLM重新排名+关键词搜索补充。
使用enhanced_db（预先计算的摘要）以获得更好的覆盖范围。"""
...
def answer_question(question: str, history: list[dict] = []) -> tuple[str, list]:
    """使用混合 RAG 回答问题。返回（答案，context_chunks）。"""
