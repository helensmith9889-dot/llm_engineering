...
class ConnectionAgent(BaseAgent):
    ...
    def _find_related_to_document(self, document_id: str, top_k: int) -> Dict:
        ...
        try:
            ...
            # 筛选 out chunks from the same 文档
            related = []
